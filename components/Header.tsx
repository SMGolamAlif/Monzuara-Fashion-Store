			...
			<div className='page-header__phones-row'>
				<div className='container page-header__phones-container'>
					<div className='page-header__phones'>
						<a href={'tel:+8801601818016'} className='page-header__phone-link'>
							<FontAwesomeIcon icon={faPhoneAlt} /> +8801681414016
						</a>
						<a href={'https://api.whatsapp.com/send?phone=+88001681414016&text=Hi!'}
							 className='page-header__phone-link'
							 target={'_blank'}
						>
							<FontAwesomeIcon icon={faWhatsapp} /> +8801681414016
						</a>
					</div>
