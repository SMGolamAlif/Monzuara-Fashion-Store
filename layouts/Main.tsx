...
import CommitNoFooter from "../components/footer/commit-no";
	...
	return (
		<>
			<Head>
				...
				<meta property="og:title" content={title || "Monzuara Fashion Store"} />
				...
				<title>{title || "Monzuara Fashion Store"}</title>
			...
			<div
				className={clsx(
					"page-layout page-layout_main moon-theme",
